...
export default function DiaryPage(){
  ...
  return <div className={styles.page}>
    ...
    {error&&<div className={styles.error} role="alert"><Icon name="warning"/>{error}</div>}{notice&&<div className={styles.notice} role="status" aria-live="polite"><Icon name="check"/>{notice}</div>}
